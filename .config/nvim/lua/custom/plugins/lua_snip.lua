    ...
    ls.add_snippets('cpp', {
      s('leet', {
        t {
          ...
          '#define printarr(x, n) cout << "{ "; forn(arrIndex, n) cout << x[arrIndex] << ", "; cout << "}\n";',
          '#define printmat(x, n, m) cout << "{\n"; forn(arrHeightIndex, n) { cout << "\t{ "; forn(arrWidthIndex, m) cout << x[arrHeightIndex][arrWidthIndex] << ", "; cout << "},\n"; }',
          '',
