...
###############################################################################
# DULOGIKA.SH - Development Environment Setup for Logic Course
#
...
teor_dir="teoreticke-ain"                                      # Directory with assignments
...
selected_branch=$(git branch --all | grep 'du[0-9]\{2\}' |
...
tmux send-keys -t logic "cd $log_base_dir/$teor_dir" C-m
